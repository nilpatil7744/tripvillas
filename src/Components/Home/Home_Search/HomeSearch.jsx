    ...
    return (
        <>
            <div className={homeSearchStyles.mainDiv}>
                <img src="https://d2v8elt324ukrb.cloudfront.net/static/new_template/media/Pimal2-1.2d5d237dbd32.jpg" alt="backGround" />
                <div className={homeSearchStyles.textDiv}>
                    <h1 style={{ fontWeight: 'bold', color: "white" }}>Book <span style={{ textDecoration: 'line-through' }}>Hotels</span> Vacation Rentals <br /> Top Holiday Homes - Villas, Apartments & Homestays</h1>
