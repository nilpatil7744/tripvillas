    ...
    <div className={style.body_container}>
      <div>
        ...
        <p className={style.listing_text}>
          Tripvillas is the leading specialist in Resort Real estate
          investments. We are strong believers that vacation homes offer both
          strong appreciation and significant yield. Please see below some
          options or feel free to write to us on passiveincome@tripvillas.com to
          get further information on currently open opportunities.
        </p>
      </div>
      <div className={style.trip_villa_div}>
        <div className={style.low_cost_div}>
          <img
            ...
            width="40px"
          />
          <h3>Low Cost High Appreciation</h3>
          <p>
        ...
        <div className={style.low_cost_div}>
          <img
            ...
            width="40px"
          />
          <h3>Guaranteed To Produce Income</h3>
          <p>
